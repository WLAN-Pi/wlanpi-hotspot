...
Test rig description:
  ...
  6. SSH to 192.168.88.1 and run this test script:
      /etc/wlanpi-hotspot/tests/hotspot_tests_01.sh
...
run_tests () {
  ...
  file_exists "/etc/wlanpi-hotspot/conf/hostapd.conf"
  file_exists "/etc/wlanpi-hotspot/default/isc-dhcp-server"
  file_exists "/etc/wlanpi-hotspot/default/ufw"
  file_exists "/etc/wlanpi-hotspot/dhcp/dhcpd.conf"
  file_exists "/etc/wlanpi-hotspot/network/interfaces"
  file_exists "/etc/wlanpi-hotspot/sysctl/sysctl.conf"
  file_exists "/etc/wlanpi-hotspot/ufw/before.rules"
